...
public class guiManual {
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("summoningstructures","textures/gui/1One.png"));
			this.drawTexturedModalRect((this.guiLeft + 2), (this.guiTop + 58), 0, 0, 256, 256);
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			...
			this.fontRendererObj.drawString("For starting mod need create", (2), (3), 0x000000);
			this.fontRendererObj.drawString("Platform 3x3 with", (2), (12), 0x000000);
			this.fontRendererObj.drawString("x1 Spawner core and", (2), (21), 0x000000);
			this.fontRendererObj.drawString("x8 Base Block", (2), (30), 0x000000);
		...
		public void initGui() {
			...
			int posX = (this.width) / 2;
			int posY = (this.height) / 2;
			this.buttonList.add(new GuiButton(0, this.guiLeft + 132, this.guiTop + 146, 44, 20, "Next"));
			...
			if (button.id == 0) {
				if (true) {
					if (entity instanceof EntityPlayer)
						((EntityPlayer) entity).openGui(instance, guiManualTwo.GUIID, world, i, j, k);
				}
			}
